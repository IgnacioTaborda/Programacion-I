...
def efecto_click(mouse_pos : tuple, click_izquierdo : tuple, boton_rectangulo : any) -> bool:
    ...
    Args:
        mouse_pos (tuple): Posición de
        click_izquierdo (tuple): _description_
        boton_rectangulo (any): _description_

    Returns:
        bool: _description_
    """
    if click_izquierdo and boton_rectangulo.collidepoint(mouse_pos):
        return True
    else:
        return False
